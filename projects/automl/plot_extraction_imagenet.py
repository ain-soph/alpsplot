...
y = {
    'loss': {
        'Manual': {
            'vgg': [4.805, 4.637, 4.704, 3.896, 3.545],
            'resnet': [4.612, 4.454, 4.256, 3.816, 2.987],
            'densenet': [4.867, 4.968, 4.252, 3.437, 2.501],
            'wideresnet': [6.217, 6.386, 7.234, 7.281, 4.863],
            'resnext': [6.142, 5.756, 5.598, 6.054, 3.869],
            'dla': [5.189, 4.666, 4.478, 4.006, 3.310],
            'mobilenet': [5.838, 5.645, 5.517, 4.650, 3.756]
        },
        'NAS': {
            'amoebanet': [6.544, 6.109, 5.628, 4.609, 3.289],
            'darts': [5.608, 5.077, 5.250, 4.784, 3.844],
            'enas': [5.128, 5.344, 4.992, 4.549, 4.235],
            'nasnet': [7.898, 7.455, 6.452, 5.317, 3.940],
            'snas_mild': [7.365, 6.045, 5.531, 4.900, 3.827],
            'pdarts': [4.772, 4.510, 4.392, 4.125, 3.786],
            'pc_darts': [5.180, 5.262, 5.828, 4.613, 4.157],
            'sgas': [5.601, 4.645, 4.337, 4.362, 3.870],
            'drnas': [4.691, 4.694, 4.261, 4.014, 3.248],
        },
    },
}
...
if __name__ == '__main__':
    ...
    fig = Figure(f'extraction_imagenet_{metric}')
    ...
    fig.set_axis_lim('x', lim=[0, 16], piece=4, margin=[0.0, 1.0],
                     _format='%d')
    if metric == 'loss':
        fig.set_axis_lim('y', lim=[4, 6], piece=4, margin=[0.0, 0.0],
                         _format='%.1f')
    else:
